...
import { PartidoAdminDto, TorneoOption, GrupoOption, EquipoOption, TipoPartidoOption, FaseOption } from "./dtos";

export const dynamic = "force-dynamic";

export default async function PartidosPage() {
  const [resP, resT, resG, resE, resTp, resF] = await Promise.all([
  ...
  const fases = resF.ok ? ((await resF.json()) as FaseOption[]) : [];
  return <PartidosClient initial={partidos} torneos={torneos} grupos={grupos} equipos={equipos} tipos={tipos} fases={fases} />;
}
